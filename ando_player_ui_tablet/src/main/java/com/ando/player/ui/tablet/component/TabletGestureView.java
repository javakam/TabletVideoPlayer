 ...
 * 手势控制
 */
public class TabletGestureView extends FrameLayout implements IGestureComponent {

    public TabletGestureView(@NonNull Context context) {
        super(context);
    }

    public TabletGestureView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public TabletGestureView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    {
        setVisibility(GONE);
        LayoutInflater.from(getContext()).inflate(R.layout.layout_tablet_gesture_control_view, this, true);
    ...
    public void onPositionChange(int slidePosition, int currentPosition, int duration) {
        ...
        if (slidePosition > currentPosition) {
            mIcon.setImageResource(R.drawable.ic_tablet_action_fast_forward);
        } else {
            mIcon.setImageResource(R.drawable.ic_tablet_action_fast_rewind);
        }
    ...
    public void onBrightnessChange(int percent) {
        ...
        mIcon.setImageResource(R.drawable.ic_tablet_action_brightness);
    ...
    public void onVolumeChange(int percent) {
        ...
        mProgressPercent.setVisibility(VISIBLE);
        if (percent <= 0) {
            mIcon.setImageResource(R.drawable.ic_tablet_action_volume_off);
        } else {
            mIcon.setImageResource(R.drawable.ic_tablet_action_volume_up);
        }
        mTextPercent.setText(percent + "%");
        mProgressPercent.setProgress(percent);
    }
