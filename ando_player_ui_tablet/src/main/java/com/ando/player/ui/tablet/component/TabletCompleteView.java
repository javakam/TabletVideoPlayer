 ...
 * 自动播放完成界面
 */
public class TabletCompleteView extends FrameLayout implements IControlComponent {

    private ControlWrapper mControlWrapper;

    private ImageView mStopFullscreen;

    public TabletCompleteView(@NonNull Context context) {
        super(context);
    }

    public TabletCompleteView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public TabletCompleteView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    {
        setVisibility(GONE);
        LayoutInflater.from(getContext()).inflate(R.layout.layout_tablet_complete_view, this, true);
        findViewById(R.id.tv_replay).setOnClickListener(new OnClickListener() {
            @Override
