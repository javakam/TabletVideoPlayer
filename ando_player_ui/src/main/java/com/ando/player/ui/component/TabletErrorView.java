 ...
 */
public class TabletErrorView extends LinearLayout implements IControlComponent {
    ...
    public TabletErrorView(Context context) {
        this(context, null);
    }

    public TabletErrorView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public TabletErrorView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    {
        setVisibility(GONE);
        LayoutInflater.from(getContext()).inflate(R.layout.layout_tablet_error_view, this, true);
