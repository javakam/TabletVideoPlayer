 ...
 * 播放器顶部标题栏
 */
public class TabletTitleView extends FrameLayout implements IControlComponent {

    private ControlWrapper mControlWrapper;

    private LinearLayout mTitleContainer;
    private TabletMarqueeTextView mTitle;
    ...
    {
        setVisibility(GONE);
        LayoutInflater.from(getContext()).inflate(R.layout.layout_tablet_title_view, this, true);
